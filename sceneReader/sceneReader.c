...
#endif
{
  ...
  {
  {
    ...
    {
    if ( (LA(1)==CAMERA) ) {
      camera(zzSTR); zzlink(_root, &_sibling, &_tail);
    }
    else {
      if ( (setwd1[LA(1)]&0x1) ) {
      }
  ...
  }
  {
    ...
    {
    if ( (LA(1)==MATERIALS) ) {
      materials(zzSTR); zzlink(_root, &_sibling, &_tail);
    }
    else {
      if ( (LA(1)==SCENE) ) {
      }
  ...
  scene(zzSTR); zzlink(_root, &_sibling, &_tail);
...
#endif
{
  ...
  zzMake0;
  {
  zzmatch(CAMERA); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
...
#endif
{
  ...
  zzMake0;
  {
  zzmatch(MATERIALS); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
    while ( (LA(1)==ID) ) {
      material(zzSTR); zzlink(_root, &_sibling, &_tail);
      zzLOOP(zztasp2);
    }
    zzEXIT(zztasp2);
    }
...
#endif
{
  ...
  zzmatch(ID); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
  {
    ...
    {
    if ( (LA(1)==COLON) ) {
      inheritance(zzSTR); zzlink(_root, &_sibling, &_tail);
    }
    else {
      if ( (LA(1)==LBRACE) ) {
      }
